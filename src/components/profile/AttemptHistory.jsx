    ...
    >
      <div className="max-w-[1000px] mx-auto pb-12">
        ...
        <div className="flex items-center justify-between border-b border-gray-200 pb-4 mb-6">
          <div>
            <h2 className="text-xl font-extrabold text-gray-800">Exam Attempts Log</h2>
            <p className="text-xs text-gray-500 font-medium">Showing {totalAttempts} submissions, ordered chronologically (newest first)</p>
          </div>
          {totalAttempts > 0 && (
            <button
        ...
        {totalAttempts === 0 ? (
          <div className="bg-white rounded-2xl border border-gray-200 p-16 text-center shadow-sm">
            ...
            <h3 className="font-extrabold text-gray-800 text-lg mb-2">No attempt logs</h3>
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      className="p-5 flex items-center justify-between gap-4 cursor-pointer hover:bg-gray-50 transition-all select-none"
                    >
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-xs text-gray-400 font-medium mt-0.5">{formatDate(att.timestamp)}</p>
                        </div>
                      </div>

                      <div className="flex items-center gap-3">
                        <span className="text-xs text-gray-400 font-mono hidden md:inline truncate max-w-xs">
                          "{att.draft.substring(0, 45)}..."
                        </span>
                        <button className="text-gray-400 text-xs font-bold bg-gray-100 hover:bg-gray-200 p-2 rounded-xl">
                    ...
                    {isExpanded && (
                      <div className="border-t border-gray-150 bg-gray-50/50 p-6 space-y-6 animate-[fadeIn_0.2s_ease]">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                          <div className="bg-white p-4 rounded-xl border border-gray-200 flex flex-col items-center justify-center">
                            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-2">Content</span>
                          ...
                          <div className="bg-white p-4 rounded-xl border border-gray-200 flex flex-col items-center justify-center">
                            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-2">Comm. Achievement</span>
                            <div className="relative w-16 h-16 flex items-center justify-center">
                              <svg className="absolute w-full h-full transform -rotate-90" viewBox="0 0 36 36">
                                <path className="text-gray-100" strokeWidth="3" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                          ...
                          <div className="bg-white p-4 rounded-xl border border-gray-200 flex flex-col items-center justify-center">
                            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-2">Organisation</span>
                            <div className="relative w-16 h-16 flex items-center justify-center">
                              <svg className="absolute w-full h-full transform -rotate-90" viewBox="0 0 36 36">
                                <path className="text-gray-100" strokeWidth="3" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                          ...
                          <div className="bg-white p-4 rounded-xl border border-gray-200 flex flex-col items-center justify-center">
                            <span className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mb-2">Language</span>
                            <div className="relative w-16 h-16 flex items-center justify-center">
                              <svg className="absolute w-full h-full transform -rotate-90" viewBox="0 0 36 36">
                                <path className="text-gray-100" strokeWidth="3" stroke="currentColor" fill="none" d="M18 2.0845 a 15.9155 15.9155 0 0 1 0 31.831 a 15.9155 15.9155 0 0 1 0 -31.831" />
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6">
                          {/* Draft Lined Paper */}
                          <div className="lg:col-span-3 bg-[#FAF9F6] border border-[#E8E0D8] rounded-xl p-5 relative overflow-hidden">
                            <div className="absolute left-6 top-0 w-0.5 h-full bg-pink-200/50" />
                            <h5 className="font-extrabold text-xs text-gray-400 uppercase tracking-wider mb-4 select-none">Submitted Writing Draft</h5>
                            <div className="font-serif text-gray-700 text-sm leading-loose whitespace-pre-wrap pl-6 min-h-[160px]">
                              {att.draft}
                            </div>
                          </div>
                          ...
                          <div className="lg:col-span-2 space-y-4">
                            ...
                            <div className="bg-white p-4 rounded-xl border border-gray-200">
                              ...
                              <ul className="space-y-1.5">
                                ...
                                )) || <li className="text-xs text-gray-400 italic">No recorded strengths.</li>}
                              </ul>
                            </div>
                            ...
                            <div className="bg-white p-4 rounded-xl border border-gray-200">
                              ...
                              <ul className="space-y-1.5">
                                ...
                                )) || <li className="text-xs text-gray-400 italic">No recorded improvements.</li>}
                              </ul>
                            </div>
                          </div>
                        </div>
                        ...
                        {att.feedback?.annotations && att.feedback.annotations.length > 0 && (
                          <div className="bg-white p-4 rounded-xl border border-gray-200">
                            <h5 className="font-bold text-xs text-gray-700 uppercase tracking-wider mb-3">Annotation Breakdowns</h5>
                            <div className="space-y-2.5">
                              {att.feedback.annotations.map((ann, idx) => (
                                <div key={idx} className="p-2.5 bg-gray-50 border border-gray-150 rounded-xl text-xs flex flex-col md:flex-row md:items-center gap-2 justify-between">
                                  <div>
                                    ...
                                    <span className="text-gray-400 capitalize">({ann.type})</span>
                                  </div>
      ...
      {showConfirmClear && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 animate-[fadeIn_0.15s_ease]">
          <div className="bg-white rounded-2xl shadow-2xl max-w-sm w-full p-6 text-center border border-gray-200">
            <span className="text-4xl block mb-3">🚨</span>
            <h3 className="font-extrabold text-gray-800 text-lg mb-2">Delete all attempt logs?</h3>
