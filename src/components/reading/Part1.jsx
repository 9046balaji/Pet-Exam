    ...
    <div>
      ...
      <div className="qcard mb-4">
        ...
        <div className="max-w-[90%] ml-auto">
          ...
          <div 
            className="rt bg-[#DCF8C6] rounded-[16px_16px_4px_16px] p-[12px_16px] leading-[1.75]" 
      ...
      <div className="qcard mb-4">
        ...
        <div 
          className="rt border-[2.5px] border-text bg-[#FFFEF0] rounded py-3.5 px-4.5 text-center" 
          style={{ fontSize: `${fontScale}em` }}
        >
      ...
      <div className="qcard mb-4">
        ...
        <div className="bg-[#F8FAFF] border border-slate-300 rounded-lg p-[12px_16px]">
          <div className="border-b border-slate-200 pb-2 mb-2.5 flex flex-col gap-0.5">
            <div className="text-[0.78em] text-slate-500">
              <b className="font-semibold">From:</b> {texts[2].from}
            </div>
            <div className="text-[0.78em] text-slate-700">
      ...
      <div className="qcard mb-4">
        ...
        <div 
          className="rt bg-[#FFFBE6] border-2 border-[#F6C90E] rounded p-[14px_16px]" 
          style={{ fontSize: `${fontScale}em` }}
        >
